...
#define EE_ADDR_flashSlave_preFlash2Time            0xA8 // WORD
  ...
  #define MSG_RUN_BARRIER               "Run Barier"
  #define MSG_RUN_SHOCK                 "Run Shock"
  #define MSG_RUN_FLASH_SLAVE           "Run Flash Slave"
  #define MSG_RESET_CONFIG 	        "Reset Config"
  #define MSG_AUTOFOCUS_TIME 	        "Autofocus Time"
  #define MSG_SHUTTERLAG_TIME 	        "Shutterlag Time"
  #define MSG_USE_FLASH1 	        "Use Flash 1"
  #define MSG_USE_FLASH2 	        "Use Flash 2"
  #define MSG_FLASH1_PRETIME 	        "Flash1 Pre-time"
  #define MSG_FLASH2_PRETIME 	        "Flash2 Pre-time"
  #define MSG_CLOSE_PRETIME 	        "Close Pre-time"
  ...
  #define MSG_INTERCICLE_TIME 	        "Intercycle Time"
  ...
  #define MSG_INTERFACE_SENSOR_MODE     "Sensor Tuning"
#endif
